/**
 * financial-tracker/components/BudgetManager.tsx
 *
 ...
 * @param selectedMonth - Currently selected month (YYYY-MM)
 * @param onMonthChange - Callback to change the selected month
 * @param budgetCategories - List of budget categories
 * @param onUpdateBudgetCategories - Callback to update categories
 */
